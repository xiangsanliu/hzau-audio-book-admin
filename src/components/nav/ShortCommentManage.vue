        ...
        <el-container>
            <el-main>
                <el-table :data="comments.slice((currentPage-1)*pageSize,currentPage*pageSize)" style="width: 100%">
                    ...
                    <el-table-column width="100" label="活动名" prop="parentName" fixed></el-table-column>
    ...
    export default {
        ...
        methods: {
            reloadComments: function () {
                this.httpGet('/comment/getAllShortComment', responseBean => {
                    this.comments = responseBean.content;
                });
            },
            approve: function (row) {
                this.httpGet(`/comment/approveShort/${row.id}`, () => {
                    this.reloadComments();
                });
            },
            disapprove: function (row) {
                this.httpGet(`/comment/disapproveShort/${row.id}`, () => {
                    this.reloadComments();
                });
            },
