                ...
                <el-table :data="bookLists">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <el-button size="mini" @click="editBookList(scope.row)" plain type="primary">编辑</el-button>
                            <el-button size="mini" @click="manageBookList(scope.row)" plain type="primary">管理书单
                            </el-button>
                            <el-button size="mini" @click="removeBookList(scope.row)" plain type="danger">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
